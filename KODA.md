# KODA.md — Контекст проекта CyberGym

## Обзор проекта

**CyberGym** — мобильное Android-приложение формата «Duolingo для киберспорта». Пользователь ежедневно получает короткую тренировочную программу по CS2, выполняет задания, зарабатывает XP, поддерживает streak и отслеживает прогресс.
